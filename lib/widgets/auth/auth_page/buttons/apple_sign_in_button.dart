import 'package:crowdleague/widgets/auth/auth_page/buttons/stretchable_button.dart';
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Image(
                      image: AssetImage(
                          "assets/images/apple_logo_${style == AppleButtonStyle.black ? "white" : "black"}.png"),
                      height: 17.0,
                      width: 17.0,
                    ),
                  ),
